...
2. Press **F3** to open debug screen
3. Note your FPS (top-left)
4. Walk around to get an average
</Steps>
...
3. Check **Memory**
4. Set **Maximum memory allocation**
5. Click **Close**
</Steps>

<Aside type="caution">
Don't allocate more than 50% of your total RAM. Leave at least 4GB for your operating system.
</Aside>
...
## Distant Horizons Tuning

Access: **Mods** → **Distant Horizons**
...
<Aside type="tip">
LODs are generated as you explore. New chunks won't have LODs until you've walked through them.
</Aside>
